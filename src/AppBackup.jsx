...
class App extends React.Component {
  ...
  forbidingSquares = (checkPieces=null) => {
    ...
    Object.keys(newPieces).forEach(piece => {
    ...
    if (!(checkPieces)) {
      this.setState({ forbidingSquaresForWhiteKing, forbidingSquaresForBlackKing, pieces: pieces }, () => {
      ...
      while ((bottomRight[0] <= 8) || (bottomRight[1] <= 8) ||
        ...
        if ((bottomRight[0] <= 8) && (bottomRight[1]) <= 8) {
          ...
          if (bottomRightObstruction === 0) {
            ...
            let tempPieces = Object.create(checkPieces);
            delete tempPieces[currentPiece.position];
            if ((this.state.turn === 'W') && (this.forbidingSquares(tempPieces)[1])) {
              console.log(bottomRight[0] + ',' + bottomRight[1], 'danger square')
            }
            if ((this.state.turn === 'B') && (this.forbidingSquares(tempPieces)[0])) {
              console.log(bottomRight[0] + ',' + bottomRight[1], 'danger square for black')
            }
            console.log(this.forbidingSquares(tempPieces))
